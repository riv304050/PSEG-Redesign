    ...
    <div className="min-h-screen flex flex-col bg-background">
      ...
      <div className="bg-primary relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 py-14 relative z-10">
          <span className="inline-flex items-center gap-2 px-4 py-1.5 bg-[hsl(var(--brand-orange))]/20 text-[hsl(var(--brand-orange))] text-sm font-semibold mb-4" data-testid="badge-support">
            <HelpCircle className="w-3.5 h-3.5" />
            Customer Support
          </span>
          <h1 className="text-4xl font-bold text-white mb-3" data-testid="heading-support">How Can We Help You?</h1>
